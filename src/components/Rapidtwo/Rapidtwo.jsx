import setelite2 from "../../assets/satelite2.jpg"
...
<div className="bg-black text-white pb-12 relative z-50">
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
                    <div className="space-y-3 xl:pr-36 p-4 border-l-2 border-l-sky-800 border-b-2 border-b-sky-800">
                    ...
                    <div>
                        <img data-aos="zoom-in" className="w-full sm:w-[80%] mx-auto max-h-[350px] object-cover" src={setelite2} alt="" />
                    </div>
                </div>
            </div>
        </div>
